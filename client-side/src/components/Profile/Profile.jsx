...
const Profile = ({setUser,type,setType,setProfile}) => {
  ...
  alt="User Icon"
  className="w-24 h-24 overflow-hidden relative group rounded-full object-cover"
/>
          <p className="text-xs text-gray-500"></p>
          <p className="text-2xl font-semibold text-gray-800 mt-3">{profileData.username}</p>
        </div>
       {type=="Seller"?( <div className="grid grid-cols-1 gap-4 mt-16 md:grid-cols-2 md:gap-6">
  <button
 ...
 <Link to={'/cart'}> <button
  ...
  <Link to={'/sellerorders'}><button
    className="py-2   px-9 border border-blue-600 text-blue-600 rounded-md hover:bg-blue-600 hover:text-white transition-all"
  >
   Seller Orders
  </button></Link>
</div>):( <div className="grid grid-cols-1 gap-4 mt-16 md:grid-cols-2 md:gap-6">
  <button
    onClick={() => setCurrentView('profile')}
    className="py-2 px-4 border border-blue-600 text-blue-600 rounded-md hover:bg-blue-600 hover:text-white transition-all"
  >
        ...
        {currentView === 'profile' ? (
          <div>
            {type=="Seller"?(<Link to={'/company'} className='float-right'>
              <button className='bg-blue-700 text-white hover:bg-blue-600 font-semibold rounded-md px-2 shadow-md py-1 '>SELL</button>
            </Link>):(<></>)}
            ...
            <div className="space-y-4">
              ...
              <img className="w-full h-full object-cover" src={profileData.profile} alt="Profile" />
              {isEditing && (
    <label
      htmlFor="profile"
